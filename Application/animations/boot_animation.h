 ...
 * @brief Modern Boot Animation with Ripple Effects and Particles for STM32 (Fixed-point arithmetic)
 * @author AI Assistant
 * @date 2025-09-07
 * @version 2.0
 * 
...
#define BOOT_ANIM_TOTAL_TIME            (BOOT_ANIM_INIT_LINE_TIME + BOOT_ANIM_SPLIT_TIME + BOOT_ANIM_TEXT_FADE_TIME + BOOT_ANIM_HOLD_TIME)
